...
'''
#ELIMINO COLUMNAS QUE NO VAN A SER MUY REPRESENTATIVAS
...
#print(data_x.dtypes)
#print(data_x.describe(include="all"))


# Categorical boolean mask
categorical_feature_mask = data_x.dtypes==object
#categorical_feature_mask = categorical_feature_mask.tolist()
...
data_x_tst[categorical_cols] = data_x_tst[categorical_cols].apply(lambda col: le.fit_transform(col))
...
'''----------------SUBMISSION-5-------------------
print("-----EXTRA TREE-----")
lgbm =ExtraTreesClassifier(n_estimators=200,
                 criterion="gini",
                 max_depth=None,
                 min_samples_split=6,
                 min_samples_leaf=1,
